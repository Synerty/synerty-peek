...
IMAGE_NAMES=""
IMAGE_NAMES="${IMAGE_NAMES} peek-debian:v3.4.x "
IMAGE_NAMES="${IMAGE_NAMES} peek-debian-test:v3.4.x "
IMAGE_NAMES="${IMAGE_NAMES} peek-debian-sonar:v3.4.x "
IMAGE_NAMES="${IMAGE_NAMES} peek-debian-build:v3.4.x "
IMAGE_NAMES="${IMAGE_NAMES} peek-debian-doc:v3.4.x "
